...
const SupportListItem = ({ item }) => {
  return /* @__PURE__ */ React__default.createElement(MenuItem, null, /* @__PURE__ */ React__default.createElement(ListItemIcon, null, /* @__PURE__ */ React__default.createElement(SupportIcon, { icon: item.icon })), /* @__PURE__ */ React__default.createElement(
    ListItemText,
    {
      primary: item.title,
